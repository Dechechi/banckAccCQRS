...
public class WithdrawFundsController {
    ...
    public ResponseEntity<BaseResponse> withdrawFunds(@PathVariable(value = "id") String id,
        ...
        try{
            ...
            return new ResponseEntity<>(new BaseResponse("Withdraw successfuly completed"), HttpStatus.OK);
        } catch (Exception e){
            var safeErrorMessage = "Error while processing request withdraw funds from bank account for id - " + id;
