...
public class DepositFundsController {
    ...
    public ResponseEntity<BaseResponse> depositFunds(@PathVariable(value = "id") String id,
        ...
        try{
            ...
            return new ResponseEntity<>(new BaseResponse("Funds successfuly deposited"), HttpStatus.OK);
        } catch (Exception e){
            var safeErrorMessage = "Error while processing request deposit funds into a bank account for id - " + id;
